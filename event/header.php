        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'index.php' ? 'active' : '' ?>" href="index.php">Карта</a>
                    </li>
                    <?php if (isset($_SESSION['user_id'])): ?>
                        <li class="nav-item">
                            <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'add_event.php' ? 'active' : '' ?>" href="add_event.php">Добавить мероприятие</a>
                        </li>
                        <?php if (in_array(array($_SESSION('user_role')), array('moderator'),array('admin'))): ?>
                        <li class="nav-item">
