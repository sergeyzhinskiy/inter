...
danger"><?php echo htmlspecialchars($error); ?></div>
                <?php endif; ?>
...
item">Пользователь: 1 / 1</li>
                        <li class="list-group-

item">Организатор: 2 / 2</li>
                        <li class="list-group-

item">Модератор: 3 / 3</li>
                        <li class="list-group-

item">Администратор: 4 / 4</li>
                    </ul>
                </div>
            </div>
        </div>
...
src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/
