...
<!-- Подключаем стабильную версию API Яндекс.Карт -->
...
<script>
    ...
    function initMap() {
        const map = new ymaps.Map("map", {
            center: [56.8587, 35.9176], // Тверь
            zoom: 10
        });

        // Добавляем маркер с балуном
        const placemark = new ymaps.Placemark(
            [56.8587, 35.9176],
            {
                balloonContent: "Пример мероприятия",
                iconCaption: "Название мероприятия"
            },
            {
